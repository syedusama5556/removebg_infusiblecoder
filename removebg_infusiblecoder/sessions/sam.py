...
class SamSession(BaseSession):
    ...
    def download_models(cls, *args, **kwargs):
        ...
        pooch.retrieve(
            f"https://github.com/syedusama5556/removebg_infusiblecoder/releases/download/v0.0.0/{fname_encoder}",
            None,
            fname=fname_encoder,
        ...
        pooch.retrieve(
            f"https://github.com/syedusama5556/removebg_infusiblecoder/releases/download/v0.0.0/{fname_decoder}",
            None,
            fname=fname_decoder,
            path=cls.u2net_home(*args, **kwargs),
            progressbar=True,
        ...
        if fname_encoder == "sam_vit_h_4b8939.encoder.onnx" and not os.path.exists(
            ...
            for i in range(1, 4):
                pooch.retrieve(
                    f"https://github.com/syedusama5556/removebg_infusiblecoder/releases/download/v0.0.0/sam_vit_h_4b8939.encoder_data.{i}.bin",
                    None,
